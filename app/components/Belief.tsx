...
export default function Belief() {
    ...
    // ========== MOBILE LAYOUT (Horizontal, No Scroll Needed) ==========
    if (isMobile) {
        return (
            <section ref={containerRef} className="font-helvetica overflow-hidden">
                ...
                {/* BELIEF CONTENT - Horizontal Layout */}
                <div className="bg-black text-white py-12 px-26">
                    <div className="max-w-6xl mx-auto">
                        {/* Horizontal Flex Container - All 3 cards side by side */}
                            ...
                            {beliefs.map((belief, index) => {
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <motion.p
                                            className="text-white leading-tight text-sm"
                                            initial={{ opacity: 0 }}
                                            animate={isInView ? { opacity: 1 } : {}}
                        ...
                        >
                            <motion.button
                                className="font-helvetica border-3 border-white bg-[#ADDDB1] text-black px-5 py-1.5 rounded-full text-sm font-medium hover:bg-[#bdd8bf] transition cursor-pointer"
