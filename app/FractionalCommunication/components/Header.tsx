...
export default function FractionalHero() {
  ...
  const description = settings.description || "Fractional Comms is a quarterly retainer for food-forward founders who've outgrown DIY communications and need an experienced partner to lead strategy, manage messaging, content, partnerships, and launches while pulling in specialists when needed.";
