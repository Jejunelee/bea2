...
export async function GET() {
  try {
    ...
    console.error('Error fetching fractional FAQ items:', error);
...
export async function POST(request: Request) {
  try {
    ...
    console.error('Error creating fractional FAQ item:', error);
...
export async function PUT(request: Request) {
  try {
    ...
    console.error('Error updating fractional FAQ item:', error);
...
export async function DELETE(request: Request) {
  try {
    ...
    console.error('Error deleting fractional FAQ item:', error);
