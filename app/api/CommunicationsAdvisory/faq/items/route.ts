...
export async function GET() {
  try {
    ...
    console.error('Error fetching advisory FAQ items:', error);
...
export async function POST(request: Request) {
  try {
    ...
    console.error('Error creating advisory FAQ item:', error);
...
export async function PUT(request: Request) {
  try {
    ...
    console.error('Error updating advisory FAQ item:', error);
...
export async function DELETE(request: Request) {
  try {
    ...
    console.error('Error deleting advisory FAQ item:', error);
