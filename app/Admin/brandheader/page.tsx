...
export default function AdminBrandHeaderPage() {
  ...
  const handleArrowIconUpload = async (file: File) => {
    ...
    const fileName = `brand-arrow-${Date.now()}.${fileExt}`;
  ...
  return (
    <div className="min-h-screen bg-white p-8">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-3xl font-bold mb-8 text-gray-800">Brand Header Section Admin</h1>
          ...
          <div className="space-y-4">
            <div>
              ...
              <div className="flex gap-2">
                <input
                  type="color"
                  value={settings.background_gradient_start || '#e9c08f'}
