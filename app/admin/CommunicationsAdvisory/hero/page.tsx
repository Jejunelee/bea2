...
export default function AdminAdvisoryHeroPage() {
  ...
  return (
    <div className="min-h-screen bg-white p-8">
      <div className="max-w-5xl mx-auto">
        <h1 className="text-3xl font-bold mb-8 text-gray-800">Hero Section Admin (Advisory)</h1>
                ...
                <div className="mt-3">
                  ...
                  <div className="flex gap-2">
                    <input
                      ...
                      placeholder="Add word or phrase to italicize (e.g., sharper mind)"
