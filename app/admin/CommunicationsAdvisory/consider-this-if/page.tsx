...
import type { AdvisoryConsiderSettings, AdvisoryConsiderItem } from '@/app/types/CommunicationsAdvisory/ConsiderThisIf';

export default function AdminAdvisoryConsiderPage() {
  ...
  const updateItem = async (id: number, field: keyof AdvisoryConsiderItem, value: string | number) => {
  ...
  return (
    <div className="min-h-screen bg-white p-8">
      <div className="max-w-6xl mx-auto">
        <h1 className="text-3xl font-bold mb-8 text-gray-800">Consider This If - Admin (Advisory)</h1>
              ...
              <div className="border-b border-gray-200 pb-4">
                ...
                <div className="flex gap-2">
                  <input
                    ...
                    placeholder="Add word or phrase to emphasize (e.g., holding the strategy)"
                    className="flex-1 p-2 border border-gray-300 rounded bg-white text-gray-800"
