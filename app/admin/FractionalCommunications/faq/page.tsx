...
export default function AdminFractionalFAQPage() {
  ...
  const updateFAQ = async (id: number, field: keyof FractionalFAQItem, value: string | number) => {
  ...
  return (
    <div className="min-h-screen bg-white p-8">
      <div className="max-w-6xl mx-auto">
        <h1 className="text-3xl font-bold mb-8 text-gray-800">FAQ Section Admin (Fractional)</h1>
