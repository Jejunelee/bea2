...
export default function AdminFractionalBridgePage() {
  ...
  const handleImageUpload = async (file: File) => {
    ...
    const fileName = `fractional-bridge-${Date.now()}.${fileExt}`;
  ...
  return (
    <div className="min-h-screen bg-white p-8">
      <div className="max-w-5xl mx-auto">
        <h1 className="text-3xl font-bold mb-8 text-gray-800">Bridge Statement Admin (Fractional)</h1>
              ...
              <div className="border-b border-gray-200 pb-4">
                ...
                <div className="mt-3">
                  ...
                  <div className="flex flex-wrap gap-2 mb-2">
                    ...
                    {(!settings.paragraph_one_emphasis || settings.paragraph_one_emphasis.length === 0) && (
                  ...
                  <div className="flex gap-2">
                    <input
                      ...
                      placeholder="Add phrase to emphasize (e.g., expensive and slow)"
              ...
              <div className="border-b border-gray-200 pb-4">
                ...
                <div className="mt-3">
                  ...
                  <div className="flex flex-wrap gap-2 mb-2">
                    ...
                    {(!settings.paragraph_two_emphasis || settings.paragraph_two_emphasis.length === 0) && (
                      <span className="text-xs text-gray-400">No emphasis phrases added</span>
                    )}
                  </div>
                  <div className="flex gap-2">
                    <input
                      ...
                      placeholder="Add phrase to emphasize (e.g., senior Brand & Comms Director)"
                      className="flex-1 p-2 border border-gray-300 rounded bg-white text-gray-800"
          ...
          <div className="bg-white rounded-lg border border-gray-200 p-6">
            ...
            >
              ...
              <div className="relative z-10 max-w-4xl mx-auto">
                {/* Paragraph 1 Preview */}
                <p 
                  className="text-xl md:text-2xl lg:text-3xl leading-relaxed font-helvetica mb-6"
