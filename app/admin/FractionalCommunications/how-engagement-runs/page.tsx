...
export default function AdminFractionalEngagementPage() {
  ...
  return (
    <div className="min-h-screen bg-white p-8">
      <div className="max-w-6xl mx-auto">
        <h1 className="text-3xl font-bold mb-8 text-gray-800">How Engagement Runs - Admin (Fractional)</h1>
                  ...
                  <div className="mb-3">
                    ...
                    <div className="flex gap-2">
                      <input
                        ...
                        placeholder="e.g., discovery call, scoped proposal"
                        className="flex-1 p-2 border border-gray-300 rounded bg-white text-gray-800"
                      />
                    </div>
