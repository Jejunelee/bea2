...
export default function AdminWalkAwayPage() {
  ...
  const fetchAllData = async () => {
    ...
    const { data: itemsData } = await supabase
      .from('foundation_walkaway_items')
      .select('*')
  ...
  const updateItem = async (id: number, field: keyof WalkAwayItem, value: string | number) => {
  ...
  return (
    <div className="min-h-screen bg-white p-8">
      <div className="max-w-6xl mx-auto">
        <h1 className="text-3xl font-bold mb-8 text-gray-800">What You Walk Away With - Admin (Foundation)</h1>
        ...
        {activeTab === 'items' && (
          <div className="bg-white rounded-lg border border-gray-200 p-6">
            <div className="flex justify-between items-center mb-4">
              <h2 className="text-xl font-semibold text-gray-800">Walk Away Items</h2>
            ...
            >
              ...
              <div className="relative z-10 max-w-4xl mx-auto">
                ...
                <div className="mb-8 text-center">
                  ...
                  >
                    {(settings.section_title || 'What you walk away with').split(settings.italic_word || 'with')[0]}
                    <span className="font-editorial italic">
                      {settings.italic_word || 'with'}
                    </span>
                    {(settings.section_title || 'What you walk away with').split(settings.italic_word || 'with')[1]}
                  </h2>
                  <div 
