...
export default function AdminFoundationGetPage() {
  ...
  const updateItem = async (id: number, field: keyof FoundationGetItem, value: string | number) => {
  ...
  return (
    <div className="min-h-screen bg-white p-8">
      <div className="max-w-6xl mx-auto">
        <h1 className="text-3xl font-bold mb-8 text-gray-800">What You Get - Admin (Foundation)</h1>
                  ...
                  {items.slice(0, 6).map((item) => (
                    <div key={item.id} className="flex items-start gap-3">
                      <div 
                        ...
                        style={{
                          backgroundColor: settings.checkmark_background_color || '#ffffff1A',
                        }}
                      >
                        <svg 
                          className="w-3 h-3" 
