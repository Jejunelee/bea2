...
export default function AdminHowThisWorksPage() {
  ...
  return (
    <div className="min-h-screen bg-white p-8">
      <div className="max-w-5xl mx-auto">
        <h1 className="text-3xl font-bold mb-8 text-gray-800">How This Works - Admin (Foundation)</h1>
                ...
                <div className="mt-3">
                  ...
                  <div className="flex gap-2">
                    <input
                      ...
                      placeholder="Add phrase to emphasize (e.g., not a brand strategy retreat)"
                      className="flex-1 p-2 border border-gray-300 rounded bg-white text-gray-800"
                ...
                <div className="mt-3">
                  ...
                  <div className="flex gap-2">
                    <input
                      ...
                      placeholder="Add phrase to emphasize (e.g., not a content factory)"
                      className="flex-1 p-2 border border-gray-300 rounded bg-white text-gray-800"
                ...
                <div className="mt-3">
                  ...
                  <div className="flex gap-2">
                    <input
                      ...
                      placeholder="Add phrase to emphasize (e.g., Comms Advisory)"
                      className="flex-1 p-2 border border-gray-300 rounded bg-white text-gray-800"
