...
export default function AdminBridgeStatementPage() {
  ...
  const handleImageUpload = async (file: File) => {
    ...
    const fileName = `bridge-${Date.now()}.${fileExt}`;
  ...
  // Helper to render preview main text with emphasis
  const renderPreviewMainText = () => {
    const text = settings.main_text || '';
    const emphasisPhrases = settings.main_emphasis_phrases || [];
  ...
  return (
    <div className="min-h-screen bg-white p-8">
      <div className="max-w-5xl mx-auto">
        <h1 className="text-3xl font-bold mb-8 text-gray-800">Bridge Statement Admin</h1>
            ...
            <div className="space-y-6">
              ...
              <div className="border-b border-gray-200 pb-4">
                ...
                <div className="space-y-3">
                  <div>
                    <label className="block text-sm font-medium mb-1 text-gray-700">Pre-Title</label>
                    <input
                      type="text"
                      value={settings.pre_title || 'A brand audit tells you what is wrong.'}
                      onChange={(e) => setSettings({ ...settings, pre_title: e.target.value })}
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <input
                        type="text"
                        value={settings.section_title || 'The foundation fixes it.'}
                    ...
                    <div>
                      ...
                      <input
                        type="text"
                        value={settings.italic_word || 'fixes it'}
              ...
              <div className="border-b border-gray-200 pb-4">
                ...
                <div className="flex gap-2">
                  <input
                    ...
                    placeholder="Add phrase to emphasize (e.g., lot of writing)"
              ...
              <div className="relative z-10 max-w-3xl mx-auto">
                ...
                <div className="text-center mb-10">
                  <span 
                    ...
                    style={{ color: settings.muted_text_color || 'rgba(0, 0, 0, 0.3)' }}
                  >
                    {settings.pre_title || 'A brand audit tells you what is wrong.'}
                  </span>
                  <h2 
                    className="text-3xl md:text-4xl font-medium mt-3 font-helvetica"
                    style={{ color: settings.text_color || '#000000' }}
                  >
                    {(settings.section_title || 'The foundation fixes it.').split(settings.italic_word || 'fixes it')[0]}
                    <span className="font-editorial italic">
                      {settings.italic_word || 'fixes it'}
                    </span>
                    {(settings.section_title || 'The foundation fixes it.').split(settings.italic_word || 'fixes it')[1]}
                  </h2>
                </div>
                ...
                <div className="mt-10 pt-6 border-t" style={{ borderColor: `${settings.text_color}10` }}>
                  <p 
                    ...
                    style={{ color: settings.text_color || '#000000' }}
                  >
                    {settings.closing_text || 'The Foundation is how you stop patching the brand and start operating from a single source of truth.'}
                  </p>
                  <div 
