...
export default function AdminFoundationHeroPage() {
  ...
  return (
    <div className="min-h-screen bg-white p-8">
      <div className="max-w-5xl mx-auto">
        <h1 className="text-3xl font-bold mb-8 text-gray-800">Foundation Hero Section Admin</h1>
                ...
                <div className="mt-3">
                  ...
                  <div className="flex gap-2">
                    <input
                      ...
                      placeholder="Add word or phrase to italicize (e.g., 4–6 week)"
            ...
            >
              ...
              <div className="relative z-10 max-w-3xl mx-auto text-center">
                ...
                <p 
                  ...
                  style={{ color: settings.text_color || '#000000', opacity: 0.8 }}
                >
