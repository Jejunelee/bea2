...
export default function AdminFoundationCTAPage() {
  ...
  return (
    <div className="min-h-screen bg-white p-8">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-3xl font-bold mb-8 text-gray-800">CTA Section Admin (Foundation)</h1>
              ...
              <div className="border-b border-gray-200 pb-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      type="text"
                      value={settings.headline || 'Start the foundation'}
                  ...
                  <div>
                    ...
                    <input
                      type="text"
                      value={settings.italic_word || 'foundation'}
          ...
          <div className="bg-white rounded-lg border border-gray-200 p-6">
            ...
            >
              ...
              <div className="relative z-10 max-w-2xl mx-auto text-center">
                ...
                >
                  {(settings.headline || 'Start the foundation').split(settings.italic_word || 'foundation')[0]}
                  <span className="font-editorial italic">
                    {settings.italic_word || 'foundation'}
                  </span>
                  {(settings.headline || 'Start the foundation').split(settings.italic_word || 'foundation')[1]}
                </h2>
                
                {/* Subheadline Preview */}
                <p 
                  className="text-lg md:text-xl leading-relaxed mb-8 font-helvetica max-w-md mx-auto"
